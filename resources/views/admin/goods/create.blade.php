...
<form class="form-horizontal" action="{{url('goods/store')}}" method="post"  role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="goods_name" value="" class="form-control" id="firstname" 
				   placeholder="请输入商品名称">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
				...
				@foreach($brand_id as $v)
					<option value="{{$v->brand_id}}">{{$v->brand_name}}</tption>
				@endforeach
				</select>
		...
		<div class="col-sm-10">
				...
				@foreach($cate_id as $v)
					<option value="{{$v->cate_id}}">{{str_repeat('|——>',$v->level)}}{{$v->cate_name}}</tption>
				@endforeach
				</select>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text"  name="goods_price" value=""class="form-control" id="firstname" 
				   placeholder="请输入商品价格">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text"   name="goods_num" value="" class="form-control" id="firstname" 
				   placeholder="请输入商品库存">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<input type="radio"  name="is_dest" value="0">否
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="radio" name="is_silde" ckecked value="1">是
			<input type="radio" name="is_silde"  value="0">否
		</div>
	</div>
		<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">商品详情</label>
		<div class="col-sm-10">
			<textarea name="goods_desc"  cols="40" rows="10"></textarea>
