...
<nav class="navbar navbar-inverse" role="navigation">
	...
	<!-- 导航栏 -->
		...
		<center><h2><font color='red'>分类添加页面</font></h2>
...
<form role="form" action="{{url('/category/store')}}"method="post">
	...
	<div class="form-group">
		...
		<input class="form-control input-lg" name="cate_name"  type="text" placeholder="请输入分类名称">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<h3><font color='red'>分类简介↓</font></h3>
				<textarea name="cate_desc"  cols="200" rows="10"></textarea>
	</div>
	<input type="submit" class="btn btn-info btn-lg" value="点击添加新分类">
</form>
