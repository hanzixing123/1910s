...
<form class="form-horizontal" role="form" action="{{url('lianjie/store')}}"method="post"enctype="multipart/form-data">
	@csrf
	<div class="form-group has-success">
		...
		<div class="col-sm-10">
			<input type="text" name="name" value="" class="form-control" id="inputSuccess">
	...
	<div class="form-group has-warning">
		...
		<div class="col-sm-10">
			<input type="text"name="url" value=""  class="form-control" id="inputWarning">
	...
	<input type="radio" name="radio" value="1" checked>LOGO连接		
	<input type="radio" name="radio" value="0" >文字连接		
	</div>
	...
	<div class="form-group has-error">
		...
		<div class="col-sm-10">
			<input type="text"name="Contact" value=""  class="form-control" id="inputError">
	...
	<div class="form-group has-error">
		<label class="col-sm-1 control-label" for="inputError">
			...
			<textarea name="desc" id="" cols="130" rows="10"></textarea>
	...
	<input type="radio" name="is_del" value="1" checked>是		
	<input type="radio" name="is_del" value="0" >否			
	</div>
<input type="submit" class="btn btn-info btn-lg" value="添加新连接">
</form>
