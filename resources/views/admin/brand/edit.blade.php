...
<nav class="navbar navbar-inverse" role="navigation">
  ...
  <!-- 导航栏 -->
     ...
     <center> <h2><font color='red'>编辑页面</font><h2>
 <a href="{{url('/brand')}}" type="button" class="btn btn-info btn-lg">查看列表</a> 
     </center>

<form   action="{{url('brand/update/'.$res->brand_id)}}"method="post"class="form-horizontal" role="form"
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
        <img width="200"  src="{{env('TUPIAN_URL')}}{{$res->brand_logo}}">

      <input type="file"   name="brand_logo" value="{{$res->brand_logo}}"  class="form-control" id="lastname" 
    ...
    <div class="col-sm-10">
      <textarea name="brand_desc" cols="200"    placeholder="请输入品牌描述" rows="10">{{$res->brand_desc}} </textarea>
